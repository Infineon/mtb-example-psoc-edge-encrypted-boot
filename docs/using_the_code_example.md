...
The following example clones the "[Encrypted Boot](https://github.com/Infineon/mtb-example-psoc-edge-encrypted-boot)" application with the desired name "EncryptedBoot" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-encrypted-boot --user-app-name EncryptedBoot --target-dir "C:/mtb_projects"
   ```
